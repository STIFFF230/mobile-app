...
/// Biblioteca de streaming científico, equivalente a
/// screens/StreamingScreen.tsx.
class StreamingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final featured = mockVideos.first;
    ...
    return ListView(
      ...
      children: [
        Material(
          ...
          child: InkWell(
            borderRadius: BorderRadius.circular(AppRadius.xl),
            onTap: () => nav.navigate(AppScreen.videoPlayer),
            child: Container(
        ...
        for (final video in mockVideos) ...[
          _VideoTile(video: video, onTap: () => nav.navigate(AppScreen.videoPlayer)),
